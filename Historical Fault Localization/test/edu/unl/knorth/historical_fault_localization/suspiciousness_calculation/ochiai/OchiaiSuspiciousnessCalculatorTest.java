...
public class OchiaiSuspiciousnessCalculatorTest {
    @Test
    public void exampleFromPaper() {
        ...
        OchiaiSuspiciousnessCalculator calculator =
                new OchiaiSuspiciousnessCalculator();
        ...
        assertEquals(0.577D, statement1Suspiciousness, 0.0005D);
        assertEquals(0.577D, statement2Suspiciousness, 0.0005D);
        assertEquals(0.577D, statement3Suspiciousness, 0.0005D);
        assertEquals(0.577D, statement4Suspiciousness, 0.0005D);
        assertEquals(0.577D, statement5Suspiciousness, 0.0005D);
        assertEquals(0.577D, statement6Suspiciousness, 0.0005D);
        assertEquals(0.500D, statement7Suspiciousness, 0.0005D);
